...
int main()
{
	...
	case 8:
		...
		break;
	case 9:
		cout <<"Ban Danh Gia Chung Toi May SAO:  ";
		cin >> x;
		if(x < 3)
			cout << "Ban Da Danh Gia " << x << "SAO Comment  cho chung toi gop y cua ban nhe.CAM On \n";
		else
			cout << "Ban Da Danh Gia chung toi " << x << " SAO CAM ON NHE.\nTAMBIET\n" ;
		break;
	default:
		break;
	}
