...
//Cau 4.2 Xuat ma tran cua do thi
void outputGraph()
{
	for(int i = 0; i < n; i++)
	{
...
//Cau 4.4 Duyet do thi theo chieu DFS (Dung STACK)
int dfs[100];
int ndfs = 0;
void DFS(int s)
{
...
int main()
{
	...
	cout << "5. Duyet theo chieu rong BFS - DSLK" << endl;
	cout << "6. Duyet theo chieu sau DFS - DSLK" << endl;
